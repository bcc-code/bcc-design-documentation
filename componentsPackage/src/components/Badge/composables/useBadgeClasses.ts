...
const badgeTextClasses: Record<BadgeType, string> = {
    ...
    custom: 'text-red-800 dark:text-green-900',
    custom2: 'text-purple-800 dark:text-yellow-900',
...
const badgeTypeClasses: Record<BadgeType, string> = {
    ...
    custom: 'bg-yellow-100 dark:bg-green-200',
    custom2: 'bg-pink-100 dark:bg-blue-200',
